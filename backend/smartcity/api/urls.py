...
urlpatterns = [
    ...
    #rotas das funções de importação por Excel registradas
    path('popular/locais/', popular_locais, name='popular_locais'),
    path('popular/responsaveis/', popular_responsaveis, name='popular_responsaveis'),
    path('popular/ambientes/', popular_ambientes, name='popular_ambientes'),
    path('popular/microcontroladores/', popular_microcontroladores, name='popular_microcontroladores'),
    path('popular/sensores/', popular_sensores, name='popular_sensores'),
    path('popular/historicos/', popular_historicos, name='popular_historicos'),
